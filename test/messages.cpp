...
void test_inbound_message_invalid_data(void) {
    ...
    ACC::Radio::InboundMessage message(input, 5);
    ...
    TEST_ASSERT_EQUAL(0, message.getNounce());
...
void test_inbound_message_without_data(void) {
    ...
    ACC::Radio::InboundMessage message(input, 32);
    TEST_ASSERT_EQUAL(0, message.getExtendedBytesLength());
    ...
    TEST_ASSERT_EQUAL(0x74646B, message.getNounce());
...
void test_inbound_message_with_data(void) {
    ...
    ACC::Radio::InboundMessage message(input, 37);
...
void test_outbound_message_without_data(void) {
    ACC::Radio::OutboundMessage message(0xA1, 0xA2, 0x02, 0x74646B);
...
void test_outbound_message_with_data(void) {
    ...
    ACC::Radio::OutboundMessage message(0x01, 0x7D, 0x7E, 0x74646B, data, 2 * sizeof(unsigned short));
    const unsigned char expectedData[] = {
